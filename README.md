...
│   ├── intern_dashboard.html         # Intern Portal: Spec editor & catalog upload console
...
| **Guest** | Read-only access to motor catalog, charts, comparisons. | `/guest_dashboard`, `/performance_analytics` |
| **Intern** | Read/Write access to motors. Create/edit motor entries, import raw catalogs. | `/intern_dashboard`, `/performance_analytics` |
