...
router.get('/init-data', guestLimiter, requireRole('admin', 'user', 'guest'), dataController.initData);

// Motors routes
router.get('/motors', guestLimiter, requireRole('admin', 'user', 'guest'), dataController.getMotors);
...
// Categories routes
router.get('/categories', guestLimiter, requireRole('admin', 'user', 'guest'), dataController.getCategories);
...
// Custom Specs routes
router.get('/custom-specs', guestLimiter, requireRole('admin', 'user', 'guest'), dataController.getCustomSpecs);
...
// Onboarding routes
router.get('/onboarding', guestLimiter, requireRole('admin', 'user', 'guest'), dataController.getOnboarding);
router.post('/onboarding', guestLimiter, requireRole('admin', 'user', 'guest'), dataController.saveOnboarding);

// User Profiles routes
router.get('/user-profiles', guestLimiter, requireRole('admin', 'user'), dataController.getUserProfiles);
