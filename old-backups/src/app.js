...
['/user/dashboard', '/user_dashboard', '/user/dashboard', '/user_dashboard',
...
['/user/explorer', '/user_explorer', '/user/explorer', '/user_explorer',
 '/guest/explorer', '/guest_explorer', '/motor_explorer'].forEach(p => app.get(p, redir('/explorer')));
['/user/login', '/user/login', '/guest/login'].forEach(p => app.get(p, redir('/login')));
