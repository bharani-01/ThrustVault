...
let credentials;
console.log('[Main Cognito Config] NODE_ENV:', process.env.NODE_ENV);
console.log('[Main Cognito Config] AWS_ACCESS_KEY_ID present:', !!process.env.AWS_ACCESS_KEY_ID);
console.log('[Main Cognito Config] AWS_SECRET_ACCESS_KEY present:', !!process.env.AWS_SECRET_ACCESS_KEY);
